...
export interface IBaseViewState extends React.Props<IBaseViewState> {
	
};

abstract class BaseViewComponent<P extends IBaseViewProps, S extends IBaseViewState> extends React.Component<P, S>{
